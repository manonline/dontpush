...
CHECKING OUT THE CODE
  ...
  The source code is maintained in dontpush Subversion repository. To check
  out the latest development version, use the following command:

    $ svn co http://example.com/svn/.../trunk dontpush

EDITING THE CODE IN AN IDE

  The dontpush add-on project can be imported in any IDE that supports Maven.
