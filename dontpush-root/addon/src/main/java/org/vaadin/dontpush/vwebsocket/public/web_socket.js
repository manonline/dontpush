...
(function() {
  ...
  // GWT module support, expect hte WebSocketMain to be in same dir as swfobject
  var scripts =document.getElementsByTagName("script");
  for ( var i = 0; i < scripts.length; i++) {
	  var script = scripts[i];
	  if(script.src.indexOf("swfobject") > 0) {
		  var url = script.src;
		  url = url.replace("swfobject\.js","WebSocketMain.swf");
		  WEB_SOCKET_SWF_LOCATION = url;
		  break;
	  }
  }
